  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 lg:hidden p-2 rounded-lg bg-gray-300 text-white shadow-xl hover:bg-blue-700 transition"
      >
        <Menu size={24} />
      </button>
      ...
      <button
        ...
        className={`fixed top-4 z-50 p-2 rounded-lg text-gray-800 shadow-xl transition-all duration-300 lg:block hidden 
          ${sidebarCollapsed 
            ? 'left-4 bg-gray-300 hover:bg-blue-700' // Opaque lorsque masqué
      ...
      <aside
        ...
        className={`fixed inset-y-0 left-0 z-40 flex flex-col bg-white/80 dark:bg-gray-800/80 text-gray-800 transition-all duration-300 backdrop-blur-sm
